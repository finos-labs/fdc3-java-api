...
/**
 * Listener for private channel disconnect events.
 */
public class PrivateChannelDisconnectEventListener extends AbstractPrivateChannelEventListener {
    ...
    public PrivateChannelDisconnectEventListener(
        ...
        super(
            ...
            channelId,
            Arrays.asList("privateChannelOnDisconnectEvent"),
            "disconnect",
            handler
        );
    }
