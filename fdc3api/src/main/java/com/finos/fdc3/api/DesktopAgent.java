...
public interface DesktopAgent {
   ...
   * ```
   */
  CompletionStage<AppIntent> findIntent(String indent, Context context, String resultType);
  
  default CompletionStage<AppIntent> findIntent(String indent, Context context) {
      return findIntent(indent, context, null);
  }
  
  default CompletionStage<AppIntent> findIntent(String indent) {
      return findIntent(indent, null);
  }
