#!/usr/bin/env bash
# Builds a macOS .app bundle with jpackage and registers the fdc3-java-workbench:// URL scheme.
#
# Usage (from repo root or fdc3-java-workbench):
#   fdc3-java-workbench/scripts/macos/build-app.sh [app-version]
#
...
APP_NAME="FDC3 Java Workbench"
MAIN_JAR="fdc3-java-workbench-1.0.0-SNAPSHOT.jar"
MAIN_CLASS="org.finos.fdc3.workbench.WorkbenchApp"
BUNDLE_ID="org.finos.fdc3.workbench"
URL_SCHEME="fdc3-java-workbench"
...
if [[ ! -f "$JAR_PATH" ]]; then
  echo "error: JAR not found at $JAR_PATH — run: mvn package -pl fdc3-java-workbench -am" >&2
  exit 1
fi
