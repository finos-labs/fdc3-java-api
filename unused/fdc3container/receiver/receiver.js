...
const handleContext = (context) => {
    console.log(context);
    let instrumentName =  document.getElementById("instrument-name");
    instrumentName.innerText = context.name;
    document.getElementById("ticker-id").innerText = context.id.ticker;
    document.getElementById("ric-id").innerText = context.name;
}